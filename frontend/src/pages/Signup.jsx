        ...
        <div className="glass-premium rounded-[2.5rem] p-10 shadow-2xl border border-white/5 space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label className="text-xs font-black uppercase tracking-widest text-muted-foreground ml-1 opacity-70">Name</label>
              <div className="relative group">
                <User className="absolute left-5 top-1/2 -translate-y-1/2 text-muted-foreground transition-colors group-focus-within:text-primary" size={20} />
                <input
                  type="text"
                  required
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase font-black tracking-widest text-muted-foreground">
              <span className="bg-[#0c111c] px-4">Already have an account?</span>
            </div>
          </div>
